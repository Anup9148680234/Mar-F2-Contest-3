...
const scrape = async () => {
    ...
    console.log("Repo Name " ,ReponameAndDescription);

    var Desc = await page.evaluate(function() {
        var Main_List = Array.from(document.getElementsByClassName('f6 color-fg-muted mt-1'))
    ...
    for(var i=0; i< Name_of_Developer.length; i++){
        ...
        dev_data.Repo_Name = ReponameAndDescription[i];
        dev_data.Description = Desc[i];
